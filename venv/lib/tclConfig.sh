...
# installed.
TCL_PREFIX='/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_57xzmki7k8/croot/tk_1748849401630/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/include -mmacosx-version-min=10.15 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/lib -L/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/include'
...
TCL_PACKAGE_PATH='{/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Volumes/DataDisk/ECMO/Aggregator/Aggregator/venv/lib/libtclstub8.6.a'
